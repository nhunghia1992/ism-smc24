...
const Comment = (props) => {
    ...
    return (
        <div className="p-3">
            ...
            <p className="text-center">{comment?.attributes?.user?.data?.attributes?.name} - {comment?.attributes?.user?.data?.attributes?.class?.data?.attributes?.name}</p>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <h2 className="text-center">Our Experience</h2>
                        </div>
                    </div>
